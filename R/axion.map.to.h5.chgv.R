...
###axion.map.to.h5.dh
#purpose: this function takes .mapTimestamps and converts them to .h5
axion.map.to.h5.chgv<-function (key, chem.info, debug = TRUE) {
  ...
  map.to.h5.chgv(s2, chem.info, h5file)
  if (debug) {

...
<<install-meadq,eval=FALSE,echo=TRUE>>=
...
<<install-meadq-github,eval=FALSE,echo=TRUE>>=
...
<<creating h5 files, eval=FALSE ,echo=TRUE >>=
...
<<create-burst-data, eval = FALSE >>=
data.file1 <- system.file("extdata", "ON_20140205_MW1007-26_DIV05_001.h5",
                          package = "meadq")
data.file2 <- system.file("extdata", "ON_20140205_MW1007-26_DIV07_001.h5",
                          package = "meadq")
data.file3 <- system.file("extdata", "ON_20140205_MW1007-26_DIV09_001.h5",
                          package = "meadq")
...
<<load-burst-data-1, eval = TRUE >>=
# to load data use the 'load' function, type ?load for more info
...
<<load-burst-data, eval=FALSE >>=
data.file <- system.file("data", "example_ont_data.rda",
 package = "meadq")
load(data.file)
@
...
require(knitr); knit2pdf('meadq-into.Rnw')
@

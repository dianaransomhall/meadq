...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{install_github}\hlstd{(}\hlstr{"sje30/sjemea"}\hlstd{)}  \hlcom{# companion pkg to meadq}
\hlkwd{install_github}\hlstd{(}\hlstr{"yihui/knitr"}\hlstd{)}  \hlcom{#to compile vignette}
\hlkwd{source}\hlstd{(}\hlstr{"http://bioconductor.org/biocLite.R"}\hlstd{)}  \hlcom{#for HDF5 files}
\hlkwd{biocLite}\hlstd{(}\hlstr{"rhdf5"}\hlstd{)}
\hlcom{# load packages into current session}
\hlkwd{require}\hlstd{(meadq)}
\hlkwd{require}\hlstd{(knitr)}
\hlkwd{require}\hlstd{(rhdf5)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{opts_chunk}\hlopt{$}\hlkwd{set}\hlstd{(}\hlkwc{cache} \hlstd{=} \hlnum{TRUE}\hlstd{)}  \hlcom{#to save time if results previously generated}
